...
const AboutUs = () => {
    ...
    const aboutImgsRef = useRef<HTMLDivElement | null>(null);
    ...
    useEffect(() => {
        ...
        const handleClick = (e: MouseEvent) => {
            ...
            const isActive = clickedImg.classList.contains(styles.active);
        ...
        <div className={styles.wrap}>
            ...
            <div className={styles.content}>
                <section className={styles.about}>
                    {heardsSvg}
                    <div className={styles.about__imgs} ref={aboutImgsRef}>
