    ...
    return (
        ...
        ${descVisible ? styles.slideInRight : ''}
           `}>
                ...
                <p>
                    ЦВМ на Разумовській є однім із найстарших ветеринарних центрів в м.Одеса. Клініка була заснована ще у 2008 році і
                ...
                <Link href='/about-us'><p className={styles.btn}><span data-text="Дізнатися більше">Дізнатися більше</span></p></Link>
