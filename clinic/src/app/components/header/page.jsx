    ...
    return (
        <>
            <div className={styles.header__top}>
                <ul>
                    <li>
                        <svg height="30" viewBox="0 0 512 512" width="30" className={styles.telephone_icon}>
                            <title />
                    ...
                    <li className={styles.hide}>
                        <svg viewBox="2 2 20 20" xmlns="http://www.w3.org/2000/svg" className={styles.map_icon}>
                        ...
                        <p>м.Одеса вул.Разумовська, 54</p>
                    </li>
                    <li>
                        <span>Ми у соціальних мережах:</span>
                        <a href="viber://chat?number=380949173380" target='_blank' rel='noopener noreferrer'  className={styles.social_icon}>
                        ...
                        <a href='mailto:razumovskayaclinic@gmail.com' rel='noopener noreferrer' className={styles.social_icon}>
